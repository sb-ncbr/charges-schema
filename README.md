...
Current version of the schema is available at [https://sb-ncbr.github.io/charges-schema/schemas/mmcif_charges_v10.dic](https://sb-ncbr.github.io/charges-schema/schemas/mmcif_charges_v10.dic).
...
```bash
gemmi validate -v mmcif_charges_v10.dic
```
...
mmcif_charges_v10.dic       1.0      https://sb-ncbr.github.io/charges-schema/schemas/mmcif_charges_v10.dic
```
